...
| 面谈编号 | 预计时间       | 对方需出席人数 | 期望                         | 开展情况 |
| -------- | -------------- | -------------- | ---------------------------- | -------- |
| 1        | 2021年12月21日 | 3              | 初步了解项目的前景与范围     | 如期执行 |
| 2        | 2021年12月22日 | 3              | 就产品详细需求与甲方达成一致 | 如期执行 |
| 3        | 2021年12月25日 | 3              | 就产品前景与甲方达成一致     | 如期执行 |
| 4        | 2021年12月27日 | 3              | 与甲方敲定文档和原型         | 如期执行 |
...
5. 如何利用客户的数据？
   ...
   通过大数据分析和人工智能手段得到用户画像。

6. 顾客会有隐私困扰吗？

   不会，我们会严格遵守相关法律法规，全力保护顾客隐私。
...
1. 软件推出刚开始有何布局？
   ...
   刚开始肯定是要广撒网，各种渠道（导游，景区，网络等等）都得有合作来吸引用户

2. 初期会不会有资金问题？

   有这种风险。软件发布初期使用人数少社区也没搭建起来不能体现出软件优势，会影响投资吸引

3. 软件的核心竞争力就是整合后的整个社区生态吗？

   是的，我们觉得成熟的社区+一站式服务可以吸引很多用户了

4. 这个和旅行社合作会不会带来一些利益冲突？

   确实会有，所以考虑到这点后我们觉得这部分合作不重要，后期不再强调了

5. 有没有什么机制防止黑导游进入？

   主要是完善认证机制，还有举报投诉功能

6. 社区管理上怎么防止和惩罚一些水军或者素质比较差的人?

   也是通过专门的客服和社区管理员

7. 用户黏度上有什么方法保证吗？

   通过优质内容，内容跟向社区，还有良好的使用体验

8. 应用里面对于创作者付费攻略收费会不会影响到创作积极性？

   会的，所以我们考虑使用力度较大的创作者激励机制

9. 会员制好像有点依赖用户基数，这个东西应该要往后放放？

   对，会在内容比较完善，优质攻略多的时候再考虑
...
<img src="Img/4.2.1.png" alt="img" style="zoom: 50%;" />

#### 4.2.2 定制私人化路线和攻略页面

<img src="Img/4.2.2.png" style="zoom:50%;" />

#### 4.2.3 攻略购买页面

<img src="Img/4.2.3.png" style="zoom:50%;" />

#### 4.2.4 个人攻略界面

**4.2.4.1  攻略列表界面**

![攻略列表LJJ](Img\攻略列表LJJ.png)
