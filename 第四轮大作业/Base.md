...
##### 2.6.1.1 初始用户少社区不成熟，愿意分享的用户少 

##### 2.6.1.2 社区环境不够好导致用户流失

##### 2.6.1.3 抽成比例不够合理导致创作者流失
...
##### 2.6.4.2 水军和低素质用户进入影响社区氛围

##### 2.6.4.3  激励机制力度不够，愿意分享的用户少
...
5. 在景区游览时使用**地图和导航**功能实施获取位置，规划路线，获取当前景点的讲解
6. 在游览之后在**用户社区**发表相关的游玩体验博客，分享游玩经历
